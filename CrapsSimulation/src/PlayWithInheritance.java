...
{
	private static Die die; // creating a Die instance variable named die
	
	public static void main (String [] args)
	{
   
		Die testObject =new CrookedDie1(); // assigned die(private instance variable) to an instance of the subclass CrookedDie1
		testObject.testStatic(); //calling die.testStatic () method
	}
